...
C
C     ====================================================================
C       SGTTSV  -  Thomas Algorithm for (tridiagonal system)
C     ====================================================================
C       Description:
C       ------------------------------------------------------------------
...
C         A(*)   : REAL               -> flat row-major matrix A (modified)
C         B(N)   : REAL               -> right-hand side (modified)
C         X(N)   : REAL               -> solution vector (output)
