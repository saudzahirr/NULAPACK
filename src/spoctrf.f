...
C
C     ====================================================================
C       SPOCTRF  -  Cholesky Factorization for A = L * L^T (single precision)
C     ====================================================================
C       Description:
C       ------------------------------------------------------------------
C         Computes the Cholesky factorization of a real symmetric
...
C         A(*) : REAL          -> flat row-major matrix, size (LDA*N)
...
C     ====================================================================
      SUBROUTINE SPOCTRF(N, A, LDA, INFO)
