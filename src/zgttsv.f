...
C
C     ====================================================================
C       ZGTTSV  -  Thomas Algorithm for (tridiagonal system)
C     ====================================================================
C       Description:
C       ------------------------------------------------------------------
...
C         A(*)   : DOUBLE COMPLEX      -> flat row-major matrix A (modified)
C         B(N)   : DOUBLE COMPLEX      -> right-hand side (modified)
C         X(N)   : DOUBLE COMPLEX      -> solution vector (output)
...
C        Check previous diagonal
         IF (A(INDEX_D) .EQ. (0.0D0,0.0D0)) THEN
            INFO = -(I-1)
            RETURN
         END IF
