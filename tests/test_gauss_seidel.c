...
void TEST_CASE_FLOAT32() {
    const char* test_name = "SGEGSSV - SINGLE PRECISION GAUSS-SEIDEL SOLVER [FLOAT32]";
...
void TEST_CASE_FLOAT64() {
    const char* test_name = "DGEGSSV - DOUBLE PRECISION GAUSS-SEIDEL SOLVER [FLOAT64]";
    PRINT_INFO(test_name);
...
void TEST_CASE_COMPLEX64() {
    const char* test_name = "CGEGSSV - COMPLEX FLOAT GAUSS-SEIDEL SOLVER [COMPLEX64]";
    PRINT_INFO(test_name);
...
void TEST_CASE_COMPLEX128() {
    const char* test_name = "ZGEGSSV - COMPLEX DOUBLE GAUSS-SEIDEL SOLVER [COMPLEX128]";
    PRINT_INFO(test_name);
